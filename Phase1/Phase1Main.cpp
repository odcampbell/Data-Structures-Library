...
int main(){
	...
	cout << "BinSearch is " << A.BinSearch(10) << endl;
	...
	cout << "BinSearch is " << A.BinSearch(15) << endl;
	A.printMyArray();
	...
	CDA<char> E(10,'X');
	E[5] = 'A';
	cout << E[5]<< E[5] << endl;   //should output A
	for (int i=0; i< E.Length();i++) cout << E[i] << " ";  cout << endl;
}